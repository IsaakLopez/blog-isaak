...
Copy-Item -Path (Join-Path $ProjectRoot "dbdata\db.sqlite3") -Destination $Staging -ErrorAction SilentlyContinue
...
#
#   schtasks /create /tn "MicroFinanzasBackup" /sc MONTHLY /mo 3 /st 02:00 /tr "powershell.exe -ExecutionPolicy Bypass -File C:\ruta\al\proyecto\scripts\backup.ps1"
#
